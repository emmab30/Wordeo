...
/* SocketService.connect(() => {
    ...
    //Subscribe to events
    SocketService.subscribe.onUsersOnlineUpdate();
    SocketService.subscribe.onRoomCreated();
    SocketService.subscribe.onRoomRemoved();
    SocketService.subscribe.onDisconnect();
    SocketService.subscribe.onRoomActivity();
    SocketService.subscribe.onStartRound();
...
export function registerScreens() {
    ...
    Navigation.registerComponent('OpenEnglish.Dashboard.Community', () => Community);
}
